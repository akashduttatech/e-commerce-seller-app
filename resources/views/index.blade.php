                            ...
                            <div class="media">
                                <div class="child-elememt">
                                    <a href="#" class="link-to">
                                        <img src="{{ asset('assets/frontend/assets/images/home-03/slide-01-child-01.png') }}"
                                            width="604" height="580" alt="">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="slide-contain slider-opt03__layout01">
                            <div class="media">
                                <div class="child-elememt"><a href="#" class="link-to"><img
                                            src="{{ asset('assets/frontend/assets/images/home-03/slide-01-child-01.png') }}"
                                            width="604" height="580" alt=""></a></div>
                            </div>
                            <div class="text-content">
                                <i class="first-line">Pomegranate</i>
                                <h3 class="second-line">Vegetables 100% Organic</h3>
                                ...
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link">
                                            <figure><img
                                                    src="{{ asset('assets/frontend/assets/images/home-03/bn_special_org.jpg') }}"
                                ...
                                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain"
                                        ...
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-05.jpg') }}"
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-07.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-02.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-03.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-06.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-20.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-19.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-22.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/products/p-18.jpg') }}"
                                                        alt="Vegetables" width="270" height="270"
                                                        class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i
                    ...
                    <div class="banner-contain">
                        <div class="media background-biolife-banner__promotion">
                            <div class="img-moving position-1">
                                <img src="{{ asset('assets/frontend/assets/images/home-03/img-moving-pst-1.png') }}"
                                    width="149" height="139" alt="img msv">
                            </div>
                            <div class="img-moving position-2">
                                <img src="{{ asset('assets/frontend/assets/images/home-03/img-moving-pst-2.png') }}"
                                    width="185" height="265" alt="img msv">
                            </div>
                            <div class="img-moving position-3">
                                <img src="{{ asset('assets/frontend/assets/images/home-03/img-moving-pst-3-cut.png') }}"
                                    width="384" height="151" alt="img msv">
                            </div>
                            <div class="img-moving position-4">
                                <img src="{{ asset('assets/frontend/assets/images/home-03/img-moving-pst-4.png') }}"
                                    width="198" height="269" alt="img msv">
                            </div>
                        </div>
                        <div class="text-content">
                                ...
                                <ul class="products biolife-carousel nav-top-right nav-none-on-mobile"
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/home-03/product_deal_330x330.jpg') }}"
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/home-03/product_deal-02_330x330.jpg') }}"
                                                        alt="dd" width="330" height="330"
                                                        class="product-thumnail">
                                                </a>
                                                <div class="labels">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('assets/frontend/assets/images/home-03/product_deal-03_330x330.jpg') }}"
                                                        alt="dd" width="330" height="330"
                                                        class="product-thumnail">
                                                </a>
                                                <div class="labels">
                    ...
                    <ul class="biolife-carousel nav-center-bold nav-none-on-mobile"
                        ...
                        <li>
                            <div class="biolife-brd-container">
                                <a href="#" class="link">
                                    <figure><img
                                            src="{{ asset('assets/frontend/assets/images/home-03/brd-01.jpg') }}"
                                            width="214" height="163" alt=""></figure>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="biolife-brd-container">
                                <a href="#" class="link">
                                    <figure><img
                                            src="{{ asset('assets/frontend/assets/images/home-03/brd-02.jpg') }}"
                                            width="214" height="163" alt=""></figure>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="biolife-brd-container">
                                <a href="#" class="link">
                                    <figure><img
                                            src="{{ asset('assets/frontend/assets/images/home-03/brd-03.jpg') }}"
                                            width="153" height="163" alt=""></figure>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="biolife-brd-container">
                                <a href="#" class="link">
                                    <figure><img
                                            src="{{ asset('assets/frontend/assets/images/home-03/brd-04.jpg') }}"
                                            width="224" height="163" alt=""></figure>
                                </a>
                            </div>
                        </li>
                        <li>
                    ...
                    <ul class="biolife-carousel nav-center nav-none-on-mobile xs-margin-top-36px"
                            ...
                            <div class="post-item effect-01 style-bottom-info layout-02 ">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img
                                            src="{{ asset('assets/frontend/assets/images/our-blog/post-thumb-01.jpg') }}"
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-meta">
                                        <a href="#" class="post-meta__item author"><img
                                                src="{{ asset('assets/frontend/assets/images/home-03/post-author.png') }}"
                                                width="28" height="28"
                        ...
                        <li>
                            <div class="post-item effect-01 style-bottom-info layout-02">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img
                                            src="{{ asset('assets/frontend/assets/images/our-blog/post-thumb-02.jpg') }}"
                                            width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                        <span class="date">26</span>
                                        <span class="month">dec</span>
                        ...
                        <li>
                            <div class="post-item effect-01 style-bottom-info layout-02">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img
                                            src="{{ asset('assets/frontend/assets/images/our-blog/post-thumb-04.jpg') }}"
                                            width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                        <span class="date">26</span>
                                        <span class="month">dec</span>
                        ...
                        <li>
                            <div class="post-item effect-01 style-bottom-info layout-02">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img
                                            src="{{ asset('assets/frontend/assets/images/our-blog/post-thumb-03.jpg') }}"
                                            width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                        <span class="date">26</span>
                                        <span class="month">dec</span>
                        ...
                        <li>
                            <div class="post-item effect-01 style-bottom-info layout-02">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img
                                            src="{{ asset('assets/frontend/assets/images/our-blog/post-thumb-05.jpg') }}"
                                            width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                        <span class="date">26</span>
                                        <span class="month">dec</span>
                        ...
                        <li>
                            <div class="post-item effect-01 style-bottom-info layout-02">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img
                                            src="{{ asset('assets/frontend/assets/images/our-blog/post-thumb-06.jpg') }}"
                                            width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                        <span class="date">26</span>
                                        <span class="month">dec</span>
