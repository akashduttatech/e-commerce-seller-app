                        ...
                        <div class="signin-container">
                            <form action="{{ route('register') }}" name="frm-login" method="post">
                                ...
                                <p class="form-row">
                                    ...
                                    <input type="text" id="fid-name" name="name" value="{{ old('name') }}"
                                        class="txt-input" required autofocus>
                                    @error('name')
                                ...
                                <p class="form-row">
                                    ...
                                    <input type="email" id="fid-name" name="email" value="{{ old('email') }}"
                                ...
                                <p class="form-row">
                                    ...
                                    <input type="password" id="fid-pass" name="password_confirmation" value=""
                                        class="txt-input" required>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="register-in-container">
                            <div class="intro">
                                ...
                                <p class="sub-title">Sign in for a faster checkout!:</p>
                                <ul class="lis">
