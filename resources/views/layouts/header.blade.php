    ...
    <div class="header-top bg-main hidden-xs">
        <div class="container">
            ...
            <div class="top-bar right">
                ...
                <ul class="horizontal-menu">
                    <li><a href="{{ route('login') }}" class="login-link"><i
            ...
            <div class="row">
                <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                    <a href="index-2.html" class="biolife-logo"><img
                            src="{{ asset('assets/frontend/assets/images/organic-3.png') }}" alt="biolife logo"
                                        ...
                                        <div
                                            ...
                                            <div class="wrap-custom-menu vertical-menu">
                                                ...
                                                <ul class="menu">
                                                    ...
                                                    <li><a href="category-grid-left-sidebar.html">Grid Left
                                                            Sidebar</a></li>
                                                    <li><a href="category-grid-right-sidebar.html">Grid Right
                                                            Sidebar</a></li>
                                                    <li><a href="category-list.html">List Full</a></li>
                                                    <li><a href="category-list-left-sidebar.html">List Left
                                                            Sidebar</a></li>
                                                    <li><a href="category-list-right-sidebar.html">List Right
                                                            Sidebar</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="block-posts">
                                                ...
                                                <ul class="posts">
                                                    <li>
                                                        <div class="block-post-item">
                                                            <div class="thumb"><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/thumb-05.jpg') }}"
                                                                        width="100" height="73"
                                                                        alt=""></a></div>
                                                            <div class="left-info">
                                                                <h4 class="post-name"><a
                                                                        href="#">Ashwagandha: The #1 Herb in
                                                    ...
                                                    <li>
                                                        <div class="block-post-item">
                                                            <div class="thumb"><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/thumb-06.jpg') }}"
                                                                        width="100" height="73"
                                                                        alt=""></a></div>
                                                            <div class="left-info">
                                                                <h4 class="post-name"><a
                                                    ...
                                                    <li>
                                                        <div class="block-post-item">
                                                            <div class="thumb"><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/thumb-07.jpg') }}"
                                                                        width="100" height="73"
                                                                        alt=""></a></div>
                                                            <div class="left-info">
                                                                <h4 class="post-name"><a
                                        ...
                                        <ul class="products">
                                            <li>
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        <a href="#"><img
                                                                src="{{ asset('assets/frontend/assets/images/minicart/pr-01.jpg') }}"
                                                                width="90" height="90"
                                            ...
                                            <li>
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        <a href="#"><img
                                                                src="{{ asset('assets/frontend/assets/images/minicart/pr-02.jpg') }}"
                                                                width="90" height="90"
                                                                alt="National Fresh"></a>
                                                    </div>
                                                    <div class="left-info">
                                            ...
                                            <li>
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        <a href="#"><img
                                                                src="{{ asset('assets/frontend/assets/images/minicart/pr-03.jpg') }}"
                                                                width="90" height="90"
                                                                alt="National Fresh"></a>
                                                    </div>
                                                    <div class="left-info">
                                            ...
                                            <li>
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        <a href="#"><img
                                                                src="{{ asset('assets/frontend/assets/images/minicart/pr-04.jpg') }}"
                                                                width="90" height="90"
                                                                alt="National Fresh"></a>
                                                    </div>
                                                    <div class="left-info">
                                            ...
                                            <li>
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        <a href="#"><img
                                                                src="{{ asset('assets/frontend/assets/images/minicart/pr-05.jpg') }}"
                                                                width="90" height="90"
                                                                alt="National Fresh"></a>
                                                    </div>
                                                    <div class="left-info">
                                                        ...
                                                        <ul class="products-list default-product-style biolife-carousel nav-none-after-1k2 nav-center"
                                                                ...
                                                                <div class="contain-product none-overlay">
                                                                    <div class="product-thumb">
                                                                        <a href="#" class="link-to-product">
                                                                            <img src="{{ asset('assets/frontend/assets/images/products/p-08.jpg') }}"
                                                                                alt="dd" width="270"
                                                                                height="270"
                                                            ...
                                                            <li class="product-item">
                                                                <div class="contain-product none-overlay">
                                                                    <div class="product-thumb">
                                                                        <a href="#" class="link-to-product">
                                                                            <img src="{{ asset('assets/frontend/assets/images/products/p-11.jpg') }}"
                                                                                alt="dd" width="270"
                                                                                height="270"
                                                                                class="product-thumnail">
                                                                        </a>
                                                            ...
                                                            <li class="product-item">
                                                                <div class="contain-product none-overlay">
                                                                    <div class="product-thumb">
                                                                        <a href="#" class="link-to-product">
                                                                            <img src="{{ asset('assets/frontend/assets/images/products/p-15.jpg') }}"
                                                                                alt="dd" width="270"
                                                                                height="270"
                                                                                class="product-thumnail">
                                                                        </a>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                                                    <div class="biolife-brand">
                                                        <ul class="brands">
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/brand-organic.png') }}"
                                                                        width="161" height="136"
                                                                        alt="organic"></a></li>
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/brand-explore.png') }}"
                                                                        width="160" height="136"
                                                                        alt="explore"></a></li>
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/brand-organic-2.png') }}"
                                                                        width="99" height="136"
                                                                        alt="organic 2"></a></li>
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/brand-eco-teas.png') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div class="biolife-brand vertical md-boder-left-30">
                                                        ...
                                                        <ul class="brands">
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/v-brand-organic.png') }}"
                                                                        width="167" height="74"
                                                                        alt="organic"></a></li>
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/v-brand-explore.png') }}"
                                                                        width="167" height="72"
                                                                        alt="explore"></a></li>
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/v-brand-organic-2.png') }}"
                                                                        width="167" height="99"
                                                                        alt="organic 2"></a></li>
                                                            <li><a href="#"><img
                                                                        src="{{ asset('assets/frontend/assets/images/megamenu/v-brand-eco-teas.png') }}"
                                                                        width="167" height="67"
                                                                        alt="eco teas"></a></li>
                                                        </ul>
                                                    </div>
